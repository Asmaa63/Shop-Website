...
import CheckoutForm from '@/components/checkout/CheckoutForm'; // Ensure this is a default import
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          {/* CheckoutForm is used correctly as a component */}
          <CheckoutForm /> 
        </motion.div>
        
        {/* --- Column 2: Order Summary (Animated Card) --- */}
        <motion.div 
