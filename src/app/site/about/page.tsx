        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Launched in 2015, ShopEC is South Asia&apos;s premier online shopping marketplace
              with an active presence in Bangladesh. Supported by a wide range of tailored
              marketing, data, and service solutions, ShopEC has 10,500 sellers and 300
              brands and serves 3 million customers across the region.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              ShopEC has more than 1 Million products to offer, growing at a very fast pace.
              ShopEC offers a diverse assortment in categories ranging from consumer
