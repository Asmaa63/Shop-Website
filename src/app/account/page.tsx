...
// FIX 1: Import the OrdersPage component
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-3">
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                                            {/* Assuming session.user?.id exists and is your MongoDB ID or similar */}
                        ...
                        {/* 2. Orders Tab - FIX: Render the OrdersPage component */}
                        {activeTab === "orders" && (
                            // The OrdersPage component already contains the main div with styles
                            <OrdersPage /> 
                        )}
